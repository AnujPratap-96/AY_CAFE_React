...
export default function About() {
  ...
  return (
    <div className="about-container max-w-4xl mx-auto p-8" style={{ backgroundColor: theme.backgroundColor }}>
      <h1 className="text-3xl font-bold" style={{ color: theme.textColor }}>
        About Our Restaurant App
      </h1>
      <p className="text-gray-600 text-lg mb-6" style={{ color: theme.subtextColor }}>
      ...
      <ul className="list-disc list-inside" style={{ color: theme.subtextColor }}>
