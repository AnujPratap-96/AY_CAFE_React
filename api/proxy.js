export default async function handler(req, res) {
  const { lat, lng, type, restaurantId, collection } = req.query;
  ...
  switch (type) {
    ...
    case "menu":
      ...
      break;
    case "pizzaList":
      targetUrl = `https://www.swiggy.com/dapi/restaurants/list/v5?lat=${lat}&lng=${lng}&tags=layout_CCS_Pizza&sortBy=&filters=&type=rcv2&offset=0&page_type=null${collection ? `&collection=${collection}` : ''}`;
      break;
    default:
